/**
 * Is Asana up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.asana.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.asana.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Asana platform status",
  description:
