/**
 * Is GitHub up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — www.githubstatus.com is deliberately NOT on the app's
...
const STATUS_HOST = "www.githubstatus.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "GitHub platform status",
  description:
    "Atlassian Statuspage rollup for www.githubstatus.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
