/**
 * Is Discord up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — discordstatus.com is deliberately NOT on the app's
...
const STATUS_HOST = "discordstatus.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Discord platform status",
  description:
    "Atlassian Statuspage rollup for discordstatus.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
