/**
 * Is OpenAI up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.openai.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.openai.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "OpenAI platform status",
  description:
