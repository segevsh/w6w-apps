/**
 * Is Zoom up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.zoom.us is deliberately NOT on the app's
...
const STATUS_HOST = "status.zoom.us";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Zoom platform status",
  description:
    "Atlassian Statuspage rollup for status.zoom.us, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
