/**
 * Is Contentful up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — www.contentfulstatus.com is deliberately NOT on the app's
...
const STATUS_HOST = "www.contentfulstatus.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Contentful platform status",
  description:
    "Atlassian Statuspage rollup for www.contentfulstatus.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
