/**
 * Is Bitbucket up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — bitbucket.status.atlassian.com is deliberately NOT on the app's
...
const STATUS_HOST = "bitbucket.status.atlassian.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Bitbucket platform status",
  description:
    "Atlassian Statuspage rollup for bitbucket.status.atlassian.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
