/**
 * Is Calendly up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — www.calendlystatus.com is deliberately NOT on the app's
 ...
 * point of a report over a boolean. `status.calendly.com` 301-redirects to
 * `www.calendlystatus.com`, which is the canonical Statuspage host used here.
 */
...
const STATUS_HOST = "www.calendlystatus.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Calendly platform status",
  description:
    "Atlassian Statuspage rollup for www.calendlystatus.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
