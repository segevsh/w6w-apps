 ...
 *   - `network.allow` — status.strava.com is deliberately NOT on the app's
 ...
 *
 * Verified 2026-08-01: `https://status.strava.com/api/v2/summary.json` is a
 * live, standard Atlassian Statuspage v2 summary endpoint — page name
 * "Strava", components include Mobile Applications / Strava.com / API /
 * Upload / AWS / MCP Connector, unauthenticated and CORS-enabled.
 */
...
const STATUS_HOST = "status.strava.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Strava platform status",
  description:
    "Atlassian Statuspage rollup for status.strava.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
