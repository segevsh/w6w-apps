/**
 * Is Klaviyo up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.klaviyo.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.klaviyo.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Klaviyo platform status",
  description:
    "Atlassian Statuspage rollup for status.klaviyo.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
