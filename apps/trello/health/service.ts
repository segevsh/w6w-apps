/**
 * Is Trello up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — trello.status.atlassian.com is deliberately NOT on the app's
...
const STATUS_HOST = "trello.status.atlassian.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Trello platform status",
  description:
