/**
 * Is Google Sheets up? — the Google Workspace Status Dashboard.
 *
 ...
 * running. The feed covers all of Workspace, so it is filtered to Google Sheets —
 * a Meet outage is not a Google Sheets outage.
 */
...
const service: HealthCheckDefinition = {
  key: "service",
  title: "Google Sheets platform status",
  description:
    "Open incidents for Google Sheets on the Google Workspace Status Dashboard. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
