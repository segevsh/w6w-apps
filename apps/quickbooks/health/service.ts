/**
 * Is QuickBooks Online up? — Atlassian Statuspage instance run by Intuit's
 * developer group.
 *
 ...
 *   - `network.allow` — status.developer.intuit.com is deliberately NOT on the
 ...
 * the per-component breakdown (confirmed: the Intuit Developer Group status
 * page publishes 8 components over the standard Statuspage vocabulary —
...
const STATUS_HOST = "status.developer.intuit.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "QuickBooks Online platform status",
  description:
    "Atlassian Statuspage rollup for status.developer.intuit.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
