...
const productUpdate: ActionDefinition<Input> = {
  ...
  params: [
    ...
    { key: "manageStock", label: "Manage Stock", type: "boolean" },
    ...
    { key: "downloadable", label: "Downloadable", type: "boolean" },
  ],
  output: [
  ...
  execute(input, ctx) {
    ...
    return client.request(`/products/${input.productId}`, { method: "PUT", body });
  },
};
