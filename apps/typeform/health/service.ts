/**
 * Is Typeform up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.typeform.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.typeform.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Typeform platform status",
  description:
    "Atlassian Statuspage rollup for status.typeform.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
