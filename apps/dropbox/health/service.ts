/**
 * Is Dropbox up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.dropbox.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.dropbox.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Dropbox platform status",
  description:
    "Atlassian Statuspage rollup for status.dropbox.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
