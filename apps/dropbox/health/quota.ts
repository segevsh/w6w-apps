...
/**
 * Dropbox exposes no headroom to read, so there is nothing to probe. Declared
...
const quota: HealthCheckDefinition = {
  ...
  unavailable: {
    reason:
      "Dropbox publishes no headroom endpoint or rate-limit headers; it answers 429 with `Retry-After` and otherwise exposes no counter.",
  },
};
