/**
 * Is Cloudflare up? — Atlassian Statuspage, same shape SendGrid publishes.
 *
 ...
 *   - `network.allow` — www.cloudflarestatus.com is deliberately NOT on the
 ...
 * Verified 2026-08-01: https://www.cloudflarestatus.com/api/v2/summary.json
 */
...
const STATUS_HOST = "www.cloudflarestatus.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Cloudflare platform status",
  description:
