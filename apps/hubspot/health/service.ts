/**
 * Is HubSpot up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.hubspot.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.hubspot.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "HubSpot platform status",
  description:
    "Atlassian Statuspage rollup for status.hubspot.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
