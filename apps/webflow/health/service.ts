/**
 * Is Webflow up? — Atlassian Statuspage at status.webflow.com.
 *
 ...
 *   - `network.allow` — status.webflow.com is deliberately NOT on the app's
 ...
 * the per-component breakdown (Data API, Hosted Websites, Site Pages, …) — one
 * probe reporting many things, which is the point of a report over a boolean.
 */
...
const STATUS_HOST = "status.webflow.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Webflow platform status",
  description:
    "Atlassian Statuspage rollup for status.webflow.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
