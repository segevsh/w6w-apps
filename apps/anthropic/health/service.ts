/**
 * Is Anthropic up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.anthropic.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.anthropic.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Anthropic platform status",
  description:
