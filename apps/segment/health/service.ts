/**
 * Is Segment up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.segment.com is deliberately NOT on the app's
 ...
 * carries the per-component breakdown — Segment's page tracks ~59 components
 * (Tracking API, Web/CDN, and per-destination delivery for streaming/
 * warehouse/blobstore/Engage/Reverse ETL, mostly split US/EU), and one call
 * reports all of them at once. Verified live 2026-08-01.
 */
...
const STATUS_HOST = "status.segment.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Segment platform status",
  description:
    "Atlassian Statuspage rollup for status.segment.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
