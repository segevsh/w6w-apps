/**
 * Is monday.com up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.monday.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.monday.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "monday.com platform status",
  description:
    "Atlassian Statuspage rollup for status.monday.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
