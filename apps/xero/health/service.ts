/**
 * Is Xero up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.xero.com is deliberately NOT on the app's
 ...
 * status.developer.xero.com; this checks the main product page
 * (status.xero.com), which is the one that covers the Accounting API this app
 * calls.
 */
...
const STATUS_HOST = "status.xero.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Xero platform status",
  description:
    "Atlassian Statuspage rollup for status.xero.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
