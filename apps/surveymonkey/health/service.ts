/**
 * Is SurveyMonkey up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.surveymonkey.com is deliberately NOT on the
 ...
 * the per-component breakdown — one probe reporting many things.
 */
...
const STATUS_HOST = "status.surveymonkey.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "SurveyMonkey platform status",
  description:
    "Atlassian Statuspage rollup for status.surveymonkey.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
