/**
 * Is Netlify up? — Atlassian Statuspage, the same platform Cloudflare and
 * SendGrid publish on.
 *
 ...
 *   - `network.allow` — www.netlifystatus.com is deliberately NOT on the
 ...
 *
 * Verified live 2026-08-01: https://www.netlifystatus.com/api/v2/summary.json
 * (page footer reads "Powered by Atlassian Statuspage").
 */
...
const STATUS_HOST = "www.netlifystatus.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Netlify platform status",
  description:
    "Atlassian Statuspage rollup for www.netlifystatus.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
