/**
 * Is Twilio up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.twilio.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.twilio.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Twilio platform status",
  description:
    "Atlassian Statuspage rollup for status.twilio.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
