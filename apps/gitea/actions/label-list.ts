...
/**
 * `GET /repos/{owner}/{repo}/labels` — verified against Gitea's Swagger
 * document.
 *
...
const action: ActionDefinition = {
  ...
  resource: "label",
  title: "List labels",
  description: "List a repository's labels — where issue creation's numeric ids come from.",
  ...
  async execute(input, ctx) {
    ...
    ctx.log("info", "listing Gitea label records", { owner, repo, returnAll });
