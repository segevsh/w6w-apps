/**
 * Is Google Docs up? — the Google Workspace Status Dashboard.
 *
 ...
 * running. The feed covers all of Workspace, so it is filtered to Google Docs —
 * a Meet outage is not a Google Docs outage.
 */
import type { HealthCheckDefinition, HealthState } from "@w6w/types";
import { worstHealthState } from "@w6w/types";

const STATUS_HOST = "www.google.com";
const SERVICE_NAME = "Google Docs";
...
const service: HealthCheckDefinition = {
  key: "service",
  title: "Google Docs platform status",
  description:
