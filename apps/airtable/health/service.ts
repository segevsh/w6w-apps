/**
 * Is Airtable up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.airtable.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.airtable.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Airtable platform status",
  description:
