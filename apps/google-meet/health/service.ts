/**
 * Is Google Meet up? — the Google Workspace Status Dashboard.
 *
 ...
 * running. The feed covers all of Workspace, so it is filtered to Google Meet —
 * a Meet outage is not a Gmail or Drive outage.
 */
import type { HealthCheckDefinition, HealthState } from "@w6w/types";
import { worstHealthState } from "@w6w/types";

const STATUS_HOST = "www.google.com";
const SERVICE_NAME = "Google Meet";
...
const service: HealthCheckDefinition = {
  key: "service",
  title: "Google Meet platform status",
  description:
    "Open incidents for Google Meet on the Google Workspace Status Dashboard. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
