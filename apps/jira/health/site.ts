/**
 * Is this connection's Jira site reachable?
 *
 * Annotation, and why each axis is what it is:
 *
 *   - `kind: "dependency"` — the vendor platform is covered by `service`
 *     (jira-software.status.atlassian.com). This is the narrower question of
 ...
 *   - `credential: "context"` — the posture a boolean would lose. Jira is the
 *     motivating case in the spec: this app's two auth methods address
