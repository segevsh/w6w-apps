/**
 * Is Jira up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — jira-software.status.atlassian.com is deliberately NOT on the app's
 ...
 *
 * Atlassian runs one Statuspage per product; `status.atlassian.com` is the cross-product rollup. This app is Jira, so it probes the Jira page — a Confluence incident is not a Jira incident.
 */
...
const STATUS_HOST = "jira-software.status.atlassian.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Jira platform status",
  description:
    "Atlassian Statuspage rollup for jira-software.status.atlassian.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
