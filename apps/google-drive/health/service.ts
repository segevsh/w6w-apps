/**
 * Is Google Drive up? — the Google Workspace Status Dashboard.
 *
 ...
 * running. The feed covers all of Workspace, so it is filtered to Google Drive —
 * a Meet outage is not a Google Drive outage.
 */
...
const service: HealthCheckDefinition = {
  key: "service",
  title: "Google Drive platform status",
  description:
    "Open incidents for Google Drive on the Google Workspace Status Dashboard. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
