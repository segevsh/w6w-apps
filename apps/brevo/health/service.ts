/**
 * Is Brevo up? — Atlassian Statuspage.
 *
 ...
 *   - `network.allow` — status.brevo.com is deliberately NOT on the app's
...
const STATUS_HOST = "status.brevo.com";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Brevo platform status",
  description:
    "Atlassian Statuspage rollup for status.brevo.com, with per-component detail. Unauthenticated and unsigned.",
  kind: "service",
  covers: ["*"],
